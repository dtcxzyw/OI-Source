...
const char* const key[] = {
    ...
    "split", "size", "siz", "modify", "query", "build",
    "DFS", "dinic", "MCMF", "dp", "mod", "powm",
    "solve", "check", "col", "dfn", "low", "write",
    "output", "input", "FFT", "init", "pre", "NTT",
    "alloc", "create", "icnt", "ecnt", "ccnt", "cnt",
    ...
    "scanf", "printf", "string", "push_back",
    "pop_back", "insert", "erase", "count", "clear",
    "reserve", "stream", "arr", "top", "psiz", "gauss",
    "queue", "cstdio", "cstring", "cmath", "climits",
    "cstdlib", "algorithm", "cctype", "MST", "bid",
    "begin", "end", "Node", "val", "src", "sum",
    "delta", "sub", "memcpy", "memset", "scan", "last",
    "cur", "bit", "dst", "move", "calc", "swap",
    "exgcd", "convexHull", "Vec", "Line", "cross",
    "dot", "length", "area", "HPI", "dir", "ori",
    "tmp", "Circle", "dis", "#include", "#define",
    "angle", "[i]", "%mod", "phi", "pos", "aug",
    "intersect", "final", "override", "random_shuffle",
