...
const char* const key[] = {
    "continue", "true", "if", "return", "typedef",
    "short", "bool", "do", "int", "typename", "break",
    "double", "long", "long long", "sizeof", "union",
    "case", "mutable", "static", "unsigned", "else",
    "namespace", "using", "char", "enum",
    "static_cast", "struct", "void", "nullptr",
    "switch", "class", "operator", "template", "const",
    "false", "private", "while", "float", "for",
    "public", "Impl", "ans", "merge", "read",
    "addEdge", "split", "size", "siz", "modify",
    "query", "build", "DFS", "dinic", "MCMF", "dp",
    "mod", "powm", "solve", "try", "check", "col",
    "dfn", "low", "write", "output", "input", "FFT",
    ...
    "getLCA", "son", "len", "fabs", "sqrt", "vector",
    "map", "set", "multi", "priority_queue",
